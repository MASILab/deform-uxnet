...
output_dir = os.path.join('/nfs/masi/leeh43/transformer_convnet/Datasets/AMOS_split/benchmark_result/train_from_scratch/out_AMOS_deformuxnet_k=3_c2')
out_classes = 16
...
model_dir = os.path.join('/nfs/masi/leeh43/monai_seg/AMOS_deformuxnet_MIDL_lr_0.0001_AdamW_k=3_offsetk=1_depthwise_THW_c2')
